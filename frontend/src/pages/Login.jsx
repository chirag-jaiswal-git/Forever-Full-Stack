...
const onSubmitHandler = async(e) => {
  ...
  setCurrentState("Login");   // Switch form to login
}
 else{
...
useEffect(()=>{
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col items-center w-[90%] sm:max-w-96 gap-4  m-auto mt-14 text-gray-900">
